...
const DesignationModal = ({ isOpen, onClose, onSave, designation, loading }) => {
...
const Designation = () => {
    ...
    const fetchDesignations = async () => {
        ...
        try {
            ...
            // Assuming the backend for designations is at /api/designations
    ...
    const handleSave = async (designationData) => {
        ...
        try {
            ...
            if (editingDesignation) {
                ...
                await axios.put(`${API_URL}/designations/${editingDesignation.id}`, designationData, {
                    headers: { "Authorization": `Bearer ${token}` }
                });
            } else {
                // Create new designation
                await axios.post(`${API_URL}/designations`, designationData, {
                    headers: { "Authorization": `Bearer ${token}` }
                });
            }
            ...
            setError('Failed to save designation. The title might already exist.');
            console.error(err);
        } finally {
