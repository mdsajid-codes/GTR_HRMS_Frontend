    ...
    return (
        <div className="flex flex-col h-screen bg-slate-50 print:bg-white print:h-auto">
            ...
            <div className="px-6 py-2 bg-[#f9f9f9] border-b text-xs text-gray-500 flex flex-col gap-1 print:hidden">
                ...
                <div className="flex justify-between w-full max-w-3xl">
                    <span>{new Date(quotation.createdAt).toLocaleString()}  Quotation Created by {quotation.createdBy || 'System'}</span>
                </div>
            </div>

            {/* Document View */}
            <div className="flex-grow overflow-y-auto p-6 bg-slate-50 flex justify-center print:p-0 print:bg-white print:overflow-visible">
                <div className="w-full max-w-[210mm] bg-white border shadow-sm p-8 min-h-[297mm] relative text-sm print:w-full print:max-w-none print:border-none print:shadow-none print:p-0">
